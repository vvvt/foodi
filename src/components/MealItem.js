    ...
    render() {
        ...
        return (
            <TouchableOpacity onPress={this.props.OnItemPressed} >
                <View style={[styles.item, { backgroundColor: meal.isEveningMeal ? "lightblue" : undefined }]}>
                    {meal.isEveningMeal ? <Icon color="yellow" name="md-moon" style={styles.moonIcon} size={25} /> : null}
                    ...
                    <View style={styles.row}>
                        ...
                        <Text numberOfLines={1} adjustsFontSizeToFit style={[styles.cardSubTitle, styles.columnRight]}>{Util.distanceToString(distance)}</Text>
                    </View>
                </View>
            </TouchableOpacity>
        );
